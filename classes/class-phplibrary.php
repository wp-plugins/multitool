...
class MULTITOOL_PHP {  
    ...
    */
    public function arrayinfo_set( $array, $line, $function, $file ){
        ...
        $array['arrayinfo']['version'] = $multitool_currentversion;
        $array['arrayinfo']['line'] = $line;
        $array['arrayinfo']['function'] = $function;
        $array['arrayinfo']['file'] = $file;
        $array['arrayinfo']['date'] = MULTITOOL::datewp();
        return $array;   
    }  
    ...
    * 2. Faster than multitool_count_extension_in_directory() because it returns sooner, important for directory with a lot of files
    * 
    * @returns boolean
    */
    ...
    */
    public function type( $value ){
        ...
        // is email address
        if( MULTITOOL::is_valid_emailaddress( $value ) ){
            return 'email';
        }                  
    ...
    */
    public function months_time_range( $month, $year, $return = 'array', $format = 'time' ){
        ...
        if( $format == 'date' )
        {
            $array['start'] = MULTITOOL::datewp(0, $array['start'] );
        }
        ...
        if( $format == 'date' )
        {    
            $array['end'] = MULTITOOL::datewp(0, $array['end'] );   
        }
