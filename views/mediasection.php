...
class MULTITOOL_MediaSection_View extends MULTITOOL_View {

    protected $screen_columns = 2;
    
    protected $view_name = 'mediasection';
    ...
    */    
    public function postbox_buildmenu_viewintroduction( $data, $box ) {
        $info_area_content = '
        <ol>
            <li>Find duplicate media.</li>
            <li>Establish media not in use so it can be deleted.</li>
            <li>Automatically build galleries and albums using keywords.</li>
            <li>Automatically display slideshows on posts based on keywords.</li>
