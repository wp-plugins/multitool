...
class MULTITOOL_Pagessection_View extends MULTITOOL_View {

    protected $screen_columns = 2;
    
    protected $view_name = 'pagessection';
    ...
    */    
    public function postbox_buildmenu_viewintroduction( $data, $box ) {
        $info_area_content = '
        <ol>
            <li>Manage multiple variations of the same page for the purpose of establishing the one that performs better.</li>
            <li>A quick view of all pages Google rank.</li>
