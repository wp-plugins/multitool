...
class MULTITOOL_MonitoringSection_View extends MULTITOOL_View {

    protected $screen_columns = 2;
    
    protected $view_name = 'monitoringsection';
    ...
    */    
    public function postbox_buildmenu_viewintroduction( $data, $box ) {
        $info_area_content = '
        <ol>
            <li>Keep a history of admin actions.</li>
            <li>Keep a history of form requests.</li>
            <li>Generate a list of members who have not visited a specific page i.e. important rules or an administration tool.</li>
