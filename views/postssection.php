...
class MULTITOOL_PostsSection_View extends MULTITOOL_View {

    protected $screen_columns = 2;
    
    protected $view_name = 'postssection';
    ...
    */    
    public function postbox_buildmenu_viewintroduction( $data, $box ) {
        ...
        <ol>
            ...
            <li>Single condition search on content and delete on find.</li>
            <li>Advanced multiple condition search and delete on post titles.</li>
