...
class MULTITOOL_SchedulingSection_View extends MULTITOOL_View {

    protected $screen_columns = 2;
    
    protected $view_name = 'schedulingsection';
    ...
    */    
    public function postbox_buildmenu_viewintroduction( $data, $box ) {
        $info_area_content = '
        <ol>
            <li>Schedule posts to phpBB but manage it from with WP. Just one example of cross platform management you can have within WP admin.</li>
            <li>Schedule mass emailing.</li>
