...
class MULTITOOL_AppearanceSection_View extends MULTITOOL_View {

    protected $screen_columns = 2;
    
    protected $view_name = 'appearancesection';
    ...
    */    
    public function postbox_buildmenu_viewintroduction( $data, $box ) {
        $info_area_content = '
        <ol>
            <li>Advanced theme editor that remembers changes and can even apply them to the theme again automatically.</li>
