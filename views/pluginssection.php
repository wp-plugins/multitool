...
class MULTITOOL_PluginsSection_View extends MULTITOOL_View {

    protected $screen_columns = 2;
    
    protected $view_name = 'pluginssection';
    ...
    */    
    public function postbox_buildmenu_viewintroduction( $data, $box ) {
        $info_area_content = '
        <ol>
            <li>Automatically store old copies of plugin prior to update.</li>
