/**
 * JavaScript code for all Multitool admin screens, it makes postboxes work
 *
 * @package Multitool
 * @subpackage Views JavaScript
 * @author Tobias Bäthge (author of MULTITOOL plugin)
 * @since 0.0.1
 */
...
jQuery( document ).ready( function( $ ) {
	 ...
	 * For MULTITOOL, pagenow has the form "tablepress_{$action}"
	 *
	 * @since 0.0.1
	 */
